          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  Do you believe in love at first sight or should I refresh this
                  page again? Our collection of gadgets is worth checking out,
                  trust me
                </p>
          ...
          <Row>
            <Col lg="6" md="12" className="count__down-col">
              <div className="clock__top-content">
                ...
                <h5 className="text-white fs-5 mb-3">Quality Armchair</h5>
              </div>
              <Clock />
              <motion.button
                whileTap={{ scale: 1.2 }}
